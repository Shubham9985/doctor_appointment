...
const AddDoctor = () => {
  ...
  const onSubmitHandler = async (event)=>{
    ...
    try {
      ...
      const {data} = await axios.post(backendURL + '/api/admin/add-dcotor' , formData , {headers:{aToken}} )
    ...
    <form onSubmit={onSubmitHandler} className='m-5 w-full'>
      ...
      <div className='bg-white px-8 py-8 border rounded w-full max-w-4xl max-h-[80vh] overflow-y-scroll'>
        ...
        <div>
          ...
          <textarea onChange={(e) => setAbout(e.target.value)} value={about} className='w-full px-4 py-2 border rounded' placeholder='write about doctor' rows={5} required></textarea>
        </div>
